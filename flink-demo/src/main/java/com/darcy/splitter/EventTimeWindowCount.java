...
public class EventTimeWindowCount {
    ...
    public static void main(String[] args) throws Exception {
        // 获取作业名
        String jobName = EventTimeWindowCount.class.getName();
        // 获取执行环境
        ...
        Map.Entry<KafkaTopic, FlinkKafkaConsumerBase> consumerBaseEntry = consumer.getConsumerByName("log.orderlog", "rz_kafka08-default-test");
